...
public abstract class RosterDAO extends BaseDAO {
	...
	public abstract ArrayList<JobTitleModel> getAllJobTitles(String activeStatus);
	...
	public abstract ArrayList<EmployeeModel> getAllEmployees(String activeStatus);
	...
	public abstract HotelModel addHotel(String hname, String haddr, String hcity, String hprov, String hpcd, String hcntry, String hphone, String hfax);
	public abstract boolean removeHotel(int hotelid);
	public abstract boolean setHotelActiveStatus(int hotelid, boolean state);
	public abstract boolean updateHotel(int hotelid, String hname, String haddr, String hcity, String hprov, String hpcd, String hcntry, String hphone, String hfax);
